      ...
      <section className={styles.section}>
          ...
          <div className={`${styles['lips']} d-flex flex-column align-items-center justify-content-center ms-motion-slideDownIn`}>
            <figure className={`ms-motion-slideDownIn`}>
              ...
              <svg width="128" height="148" viewBox="0 0 128 148" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M67.2013 92.8498L72.6186 88.7199L75.7943 86.299L78.97 83.878L86.629 78.0392L84.0581 74.6669L64.6304 89.4776L67.2013 92.8498Z" fill="#FE005B" />
                ...
                />
                <path d="M91.2122 63.8809L94.1901 61.6108L91.9367 58.655L88.9588 60.9252L91.2122 63.8809Z" fill="#FE005B" />
              </svg>
            ...
            <button className={`mt-20`}>Mint</button>
          </div>
        </div>
        ...
        <div className={`__container`} data-width={`large`}>
          ...
          <div className={`${styles['banner']} d-flex flex-column align-items-start`}>
            ...
            <ul className={`d-flex flex-row align-items-start`}>
              <li>
                <span>LSP8</span>
              </li>
              <li>
            ...
            <img className={styles['banner__img']} src={FivePercent} alt="5% back to holders" />
